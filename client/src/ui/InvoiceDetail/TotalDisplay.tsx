...
const TotalDisplay = ({ total }: TotalDisplayProps) => (
  <div className="absolute bottom-0 left-0 w-full flex justify-center items-center bg-oceanBlue rounded-[10px] md:justify-between md:mb-2.5 md:px-4 md:h-[30px]">
