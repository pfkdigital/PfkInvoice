...
const InvoiceDetail = ({
  ...
  return (
    <div
      className={
        "w-full flex-col md:grid md:grid-cols-invoice-grid md:grid-rows-1 md:pb-10 md:gap-x-8"
      }
    >
        ...
        >
          <div className={"flex-col md:pb-2.5"}>
            <div className={"flex justify-between items-start md:items-center"}>
              ...
              <div
                className={
                  "mx-2.5 px-4 py-2.5 bg-oceanBlue text-xs text-cloudGray max-h-5 rounded-[10px] flex items-center justify-center font-bold md:mx-5"
                }
              >
      ...
      <div className={"flex-col relative md:w-full"}>
        <div
          className={
            "bg-eclipse rounded-[10px] mt-2.5 p-5 md:bg-midnight md:h-fit md:mb-[70px] md:mt-0 md:p-5"
          }
        >
          ...
          <div
            className={
              "grid grid-cols-2 md:grid-cols-1 md:grid-rows-2 md:mb-2.5"
            }
          >
        ...
        <div
          className={
            "hidden absolute bottom-0 left-0 w-full justify-center items-center bg-oceanBlue rounded-[10px] md:flex md:justify-between md:mb-2.5 md:px-4 md:h-[30px]"
          }
        >
